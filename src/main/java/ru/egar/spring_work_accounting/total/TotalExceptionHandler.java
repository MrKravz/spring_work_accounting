...
public class TotalExceptionHandler extends ResponseEntityExceptionHandler implements EntityExceptionHandler<TotalException> {

    private final Logger logger = LoggerFactory.getLogger(TotalExceptionHandler.class);

    @Override
    @ExceptionHandler(value = TotalException.class)
    public ResponseEntity<ExceptionResponse> handleEntityRelatedException(TotalException ex) {
